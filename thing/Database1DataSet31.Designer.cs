...
namespace thing {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Database1DataSet31.xsd";
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int Type, string Device, string First, string Last, System.DateTime Date, string Notes) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Type {
                get {
                    return ((int)(this[this.tableTable.TypeColumn]));
                }
                set {
            ...
            public string Device {
                get {
                    try {
                        return ((string)(this[this.tableTable.DeviceColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Device\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.DeviceColumn] = value;
                }
            }
            ...
            public bool IsDeviceNull() {
                return this.IsNull(this.tableTable.DeviceColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetDeviceNull() {
                this[this.tableTable.DeviceColumn] = global::System.Convert.DBNull;
            }
...
namespace thing.Database1DataSet3TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Type] = @Original_Type) AND ((@IsNull_Device = 1 AND [Device] IS NULL) OR ([Device] = @Original_Device)) AND ((@IsNull_First = 1 AND [First] IS NULL) OR ([First] = @Original_First)) AND ((@IsNull_Last = 1 AND [Last] IS NULL) OR ([Last] = @Original_Last)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Notes = 1 AND [Notes] IS NULL) OR ([Notes] = @Original_Notes)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Type], [Device], [First], [Last], [Date], [Notes]) VA" +
                "LUES (@Type, @Device, @First, @Last, @Date, @Notes);\r\nSELECT Id, Type, Device, F" +
                "irst, Last, Date, Notes FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Type] = @Type, [Device] = @Device, [First] = @First, [Last] = @Last, [Date] = @Date, [Notes] = @Notes WHERE (([Id] = @Original_Id) AND ([Type] = @Original_Type) AND ((@IsNull_Device = 1 AND [Device] IS NULL) OR ([Device] = @Original_Device)) AND ((@IsNull_First = 1 AND [First] IS NULL) OR ([First] = @Original_First)) AND ((@IsNull_Last = 1 AND [Last] IS NULL) OR ([Last] = @Original_Last)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ((@IsNull_Notes = 1 AND [Notes] IS NULL) OR ([Notes] = @Original_Notes)));
SELECT Id, Type, Device, First, Last, Date, Notes FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::thing.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Type, Device, First, Last, Date, Notes FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, int Original_Type, string Original_Device, string Original_First, string Original_Last, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Notes) {
            ...
            if ((Original_First == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_First));
            }
            if ((Original_Last == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_Last));
            }
        ...
        public virtual int Insert(int Type, string Device, string First, string Last, global::System.Nullable<global::System.DateTime> Date, string Notes) {
        ...
        public virtual int Update(int Type, string Device, string First, string Last, global::System.Nullable<global::System.DateTime> Date, string Notes, int Original_Id, int Original_Type, string Original_Device, string Original_First, string Original_Last, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Notes, int Id) {
            ...
            if ((Original_Device == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Device));
            }
            if ((Original_First == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Type, string Device, string First, string Last, global::System.Nullable<global::System.DateTime> Date, string Notes, int Original_Id, int Original_Type, string Original_Device, string Original_First, string Original_Last, global::System.Nullable<global::System.DateTime> Original_Date, string Original_Notes) {
            return this.Update(Type, Device, First, Last, Date, Notes, Original_Id, Original_Type, Original_Device, Original_First, Original_Last, Original_Date, Original_Notes, Original_Id);
        }
    }
